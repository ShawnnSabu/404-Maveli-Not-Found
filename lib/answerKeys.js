...
export const ROUND1 = {
  questions: [
    {
      type: "song",
      prompt: "PLACEHOLDER SONG 1 — Which movie is this song from?",
    ...
    {
      type: "song",
      prompt: "PLACEHOLDER SONG 2 — Which movie is this song from?",
      options: ["Movie A", "Movie B", "Movie C", "Movie D"],
      answer: 2,
      bgVideo: "/media/round1/common-bg.mp4", // Shared background video
    ...
    {
      type: "song",
      prompt: "PLACEHOLDER SONG 3 — Which movie is this song from?",
      options: ["Movie A", "Movie B", "Movie C", "Movie D"],
      answer: 1,
      bgVideo: "/media/round1/common-bg.mp4", // Shared background video
    ...
    {
      type: "song",
      prompt: "PLACEHOLDER SONG 4 — Which movie is this song from?",
      options: ["Movie A", "Movie B", "Movie C", "Movie D"],
      answer: 3,
      bgVideo: "/media/round1/common-bg.mp4", // Shared background video
    ...
    {
      type: "song",
      prompt: "PLACEHOLDER SONG 5 — Which movie is this song from?",
      options: ["Movie A", "Movie B", "Movie C", "Movie D"],
      answer: 0,
      bgVideo: "/media/round1/common-bg.mp4", // Shared background video
