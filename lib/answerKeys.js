...
export const ROUND3 = {
  ...
  dishes: [
    { name: "Dish One", icon: "/media/dishes/dish1.png", dialogue: "/media/dishes/dish1.mp3" },
    { name: "Dish Two", icon: "/media/dishes/dish2.png", dialogue: "/media/dishes/dish2.mp3" },
    { name: "Dish Three", icon: "/media/dishes/dish3.png", dialogue: "/media/dishes/dish3.mp3" },
    { name: "Dish Four", icon: "/media/dishes/dish4.png", dialogue: "/media/dishes/dish4.mp3" },
    { name: "Dish Five", icon: "/media/dishes/dish5.png", dialogue: "/media/dishes/dish5.mp3" },
    { name: "Dish Six", icon: "/media/dishes/dish6.png", dialogue: "/media/dishes/dish6.mp3" },
    { name: "Dish Seven", icon: "/media/dishes/dish7.png", dialogue: "/media/dishes/dish7.mp3" },
    { name: "Dish Eight", icon: "/media/dishes/dish8.png", dialogue: "/media/dishes/dish8.mp3" },
  ],
