...
// ---------------------------------------------------------------------------
// ROUND 4 — Mahabali's Kodishwaran Challenge
// ---------------------------------------------------------------------------
export const ROUND4 = {
  riddles: [
    {
      prompt:
        "Maveli naadu vaanidum kaalam, manushyarellaam...?",
      options: [
        "Indiakkare pole",
        "Chinakkare pole",
        "Onnupole",
      ...
      answer: 2,
      explanation:
        "The famous Onam song says that during Maveli's reign, everyone lived alike.",
    },

    {
      prompt:
        "Maveli oru divasam Kerala sandarshikkan vannappol, aadyam entha cheyyum?",
      options: [
        "Pookalam nokkum",
        "Sadya kazhikkum",
        "Traffic nokki thirichu pokum",
        "Ellam nokkiyittu 'ente Kerala!' ennu parayum",
      ],
      answer: 1,
      explanation:
        "A good Onam celebration is incomplete without a delicious Sadya!",
    },

    {
      prompt:
        "Onam Sadya kazhikkumbol ettavum dangerous question ethaayirikkum?",
      options: [
        "Payasam undo?",
        "Iniyum chor venamo?",
        "Pappadam evide?",
        "Ellam mukalil ullathaanu",
      ],
      answer: 3,
      explanation:
        "At a Sadya, somehow every one of these questions eventually appears!",
    },

    {
      prompt:
        "Oru aal Pookalam undakki. Athu kandittu Maveli paranju: 'Nannayittundu!' Appol aa aalude next question enthaayirikkum?",
      options: [
        "Photo edukkatte?",
        "Instagram-il idatte?",
        "Prize undo?",
        "Maveli, onnu like cheyyamo?",
      ],
      answer: 1,
      explanation:
        "In today's world, even a beautiful Pookalam needs an Instagram post!",
    },

    {
      prompt:
        "Onam divasam veettil Sadya kazhichu kazhinju oral parayunnu: 'Njan full aanu!' Pinne 5 minute kazhinju...",
      options: [
        "Payasam venda ennu parayum",
        "Veendum payasam chodikkum",
        "Gym-il pokum",
        "Urangum",
      ],
      answer: 1,
      explanation:
        "The classic Onam plot twist: 'full aanu' becomes 'kurachu payasam koodi thaa!'",
    },
  ],
};
